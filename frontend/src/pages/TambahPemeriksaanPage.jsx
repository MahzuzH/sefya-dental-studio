                                                    ...
                                                    Object.entries(entries)
                                                        ...
                                                        .map(([tooth, e]) => {
                                                            ...
                                                            return (
                                                                <div
                                                                    key={tooth}
                                                                    className="rounded-xl bg-slate-50 px-3 py-2 group hover:bg-rose-50 transition-colors"
                                                                >
                                                                    ...
                                                                    {e.notes && (
                                                                        <p className="text-[11px] text-slate-400 mt-0.5 ml-5 leading-relaxed">
                                                                            {
                                                                                e.notes
                                                                            }
                                                                        </p>
