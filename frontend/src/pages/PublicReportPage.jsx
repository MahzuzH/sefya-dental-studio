...
const IMAGE_ROWS = [
    ["extraoral_frontal_rest", "extraoral_frontal_smile", "extraoral_profile"],
    ["intraoral_right_buccal", "intraoral_frontal", "intraoral_left_buccal"],
...
export default function PublicReportPage() {
    ...
    if (loading) {
        return (
            <>
                <Helmet>
                    <title>
                        Memuat Laporan... | Sefya Dental Studio Subang
                    </title>
    ...
    if (error) {
        return (
            <>
                <Helmet>
                    <title>
                        Laporan Tidak Ditemukan | Sefya Dental Studio Subang
                    </title>
                    <meta name="robots" content="noindex" />
                </Helmet>
    ...
    const reportSchema = report?.patient_name
        ? {
              ...
              datePublished:
                  report.scan_date || new Date().toISOString().split("T")[0],
              about: {
                  "@type": "Patient",
    ...
    return (
        <>
            <Helmet>
                ...
                <link
                    rel="canonical"
                    href={`https://sefyadentalstudio.web.id/report/${id}`}
                />
                <meta property="og:title" content={reportTitle} />
                <meta property="og:description" content={reportDesc} />
                <meta
                    property="og:url"
                    content={`https://sefyadentalstudio.web.id/report/${id}`}
                />
                <meta property="og:type" content="article" />
                <meta
                    property="og:image"
                    content="https://sefyadentalstudio.web.id/og-image.svg"
                />
            ...
            <div className="min-h-screen bg-white text-[#64748b] font-poppins selection:bg-[#ff91a4]/20 selection:text-[#be185d] relative z-0">
                ...
                <main className="mx-auto max-w-4xl px-2 sm:px-6 pt-8 sm:pt-10 pb-16 relative z-10">
                    ...
                    <div className="mb-8 grid grid-cols-1 sm:grid-cols-2 gap-4 animate-[fadeInUp_0.6s_ease-out_0.2s_both]">
                        ...
                        >
                            <div
                                className={cards.dentalCondition.iconWrapClass}
                            >
                    ...
                    <div className="mb-8 rounded-2xl border border-slate-200 bg-white p-3 sm:p-8 shadow-lg animate-[fadeInUp_0.6s_ease-out_0.3s_both] relative">
                        ...
                        <div className="relative mx-auto w-full pb-10">
                            <div className="flex flex-col gap-6 w-full items-center">
                                ...
                                {/* Total Issue Circle */}
                                <div
                                    className="mx-auto h-36 w-36 rounded-full bg-[#ff91a4]/10 flex flex-col items-center justify-center border-2 border-dashed border-[#ff91a4]/30 relative overflow-hidden"
                                    style={{
                                        boxShadow:
                                            "0 0 30px rgba(255,145,164,0.12), inset 0 0 20px rgba(255,145,164,0.06)",
                                    }}
                                >
                        ...
                        {report.general_notes && (
                            <div className="px-2 sm:px-4 py-4 border-t border-slate-100">
                                <div className="flex items-start gap-3">
                                    <div className="w-10 h-10 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-center shrink-0">
                                        <FileText size={16} className="text-[#ff91a4]" />
                                    </div>
                        ...
                        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2 border-t border-slate-200 pt-6">
                            {report.diagnosis?.map((d, i) => {
                                const surface = d.tooth_surface
                                    ? d.tooth_surface.charAt(0).toUpperCase() +
                                      d.tooth_surface.slice(1)
                                    : "";
                                return (
                                    <div
                                        key={i}
                                        className="rounded-xl bg-slate-50 p-2.5 transition-all hover:bg-[#ff91a4]/10 hover:border-[#ff91a4]/20 border border-transparent cursor-default"
                                        style={staggerStyle(i)}
                                    >
                                        <div className="flex items-center gap-2.5">
                                            <div
                                                className="h-2.5 w-2.5 rounded-full ring-2 ring-offset-1 ring-offset-white shrink-0"
                                                style={{
                                        ...
                                        {d.notes && (
                                            <p className="text-[10px] text-slate-500 mt-0.5 ml-5 leading-relaxed">
                                                {d.notes}
                                            </p>
                                        )}
                                    </div>
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {report.diagnosis?.length ? (
                                ...
                                <div className="rounded-2xl bg-gradient-to-br from-[#fef2f4] to-[#fff5f7] p-6 border border-[#ff91a4]/20">
                                    ...
                                    <p className="text-sm leading-relaxed text-[#64748b]">
                                        Belum ada rekomendasi perawatan dari
                                        data diagnosis.
                                    </p>
                                </div>
                            )}
                    ...
                    <div className="mt-16 pt-8 border-t border-slate-200 text-center animate-[fadeInUp_0.6s_ease-out_0.6s_both]">
                        ...
                        <p className="text-xs text-[#94a3b8] max-w-md mx-auto leading-relaxed"></p>
                    </div>
                </main>
